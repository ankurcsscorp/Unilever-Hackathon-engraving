...
function loadDoc() {
    ...
    xhttp.open("GET", "https://run.mocky.io/v3/f46aa559-c6af-4189-9c5e-a5b375cc2c6b/engravingDetail4", true);
    xhttp.send();
}
...
imageObj.src =  "../../Images/image_close7.webp";
...
if(xx.length<=2)
{
context.fillVerticalText(xx, xAxis, yAxis+50,24);
}
...
context.fillVerticalText(xx, xAxis, yAxis-2,24);
}
