...
function loadDoc() {
    ...
    xhttp.open("GET", "https://run.mocky.io/v3/f46aa559-c6af-4189-9c5e-a5b375cc2c6b/engravingDetail2", true);
    xhttp.send();
}
...
if(x.length<=2)
{
context.fillText(x, xAxis+25, yAxis);

}

else if(x.length>=3 && x.length<=5)
{
context.fillText(x, xAxis+5  , yAxis);  
}
else if (x == x.toUpperCase()) {
context.fillText(x, xAxis-3, yAxis);
}
else if (x == x.toLocaleLowerCase()) {
context.fillText(x, xAxis+6, yAxis);
}
else
{
