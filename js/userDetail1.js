...
function loadDoc() {
    ...
    xhttp.open("GET", "https://run.mocky.io/v3/f46aa559-c6af-4189-9c5e-a5b375cc2c6b/engravingDetail1", true);
    xhttp.send();
}
...
imageObj.onload = function() {
  context.drawImage(imageObj, 10, 10,imageObj.width/1.2,imageObj.height/1.2);
};
imageObj.src =  "../../Images/lipstick.jpg";
...
if(xx.length<=2)
{
context.fillVerticalText(xx, xAxis, yAxis+43,24);
}
else if(xx.length>=3 && xx.length<=4)
{
context.fillVerticalText(xx, xAxis, yAxis+15,24);
}

else if (xx == xx.toUpperCase()) {
context.fillVerticalText(xx, xAxis, yAxis-5,24);
}
